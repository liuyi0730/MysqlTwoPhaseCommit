...
//        SingleOutputStreamOperator<Tuple2<String, Integer>> tupleStream2 = inputStream.flatMap(
//                (Event event, Collector<String> words) -> {
//                    Arrays.stream(event.split(",")).forEach(words::collect);
//                }
//        ).returns(Types.STRING);
////                .returns(Types.TUPLE(Types.STRING, Types.INT));
        SingleOutputStreamOperator<Tuple2<String, Integer>> tupleStream = inputStream.map(
        ...
        tupleStream3.print("tupleStream3");
